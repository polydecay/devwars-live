<template>
    <div class="GameSidebar">
        ...
        <GameSidebarReview
            v-else-if="stage === 'reviewFunction'"
            title="Function"
...
import GameSidebarReview from './GameSidebarReview';

export default {
    components: { GameSidebarObjectives, GameSidebarReview },
